...
const roles = [
  {
    id: "developer",
    label: "Developer",
    content: "Developer role content goes here.",
    openings: "1",
    experience: "5 to 10",
  },
  {
    id: "designer",
    label: "Designer",
    content: "Designer role content goes here.",
    openings: "3",
    experience: "5 to 7",
  },
  {
    id: "manager",
    label: "Manager",
    content: "Manager role content goes here.",
    openings: "2",
    experience: "2 to 4",
  },
  {
                  ...
                  >
                    <div
                      ...
                      onMouseEnter={(e) => {
                        ...
                        ).style.backgroundColor = "#13253e"; // slightly lighter on hover
                      ...
                      onMouseLeave={(e) => {
                        (
                          e.currentTarget as HTMLDivElement
                        ).style.backgroundColor = "#0e1d2e"; // original color
                        (e.currentTarget as HTMLDivElement).style.transform =
                          "scale(1)";
                      }}
                    >
                      ...
                      <div className="job-experience">
                        <div className="job-item">
                          <img
                            className="role-icon"
                            src="http://www.nordixone.com/img/icons/zoom-in.png"
                            alt="Openings"
                          />
                          <span className="job-subitem">
                        ...
                        <div className="job-item">
                          <img
                            className="role-icon"
                            src="http://www.nordixone.com/img/icons/calendar-blue.png"
                            alt="Experience"
                          />
                          <span className="job-subitem">
                        ...
                        <img
                          ...
                          src="http://www.nordixone.com/img/icons/arrow-white.png"
                          alt="arrow"
                        />
                      </div>
                    </div>
